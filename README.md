...
Проект настроен для автоматического запуска тестов с помощью **GitHub Actions**. Pipeline запускается при каждом push или pull request в ветку `main` и выполняет следующие шаги:
